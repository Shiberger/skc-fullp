...
const Navbar2 = async () => {
  ...
  <div className="dsnavbar-start">
    <div className="dsdropdown">
      ...
      {/* Hamburger Menu */}
      <ul tabIndex={0} className="dsmenu dsmenu-sm dsdropdown-content my-4 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
      {NavLinks.map((link) => (
                <Link
                  href={link.href}
                  key={link.text}
    ...
    <a className="dsbtn dsbtn-ghost normal-case text-xl text-primary-purple">Skillsync</a>
  </div>
