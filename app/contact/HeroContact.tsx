        ...
        <div className="dshero-content text-center text-neutral-content">
          ...
          <div className="container px-6 py-10 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-8 mt-5 xl:mt-16 md:grid-cols-2 xl:grid-cols-2 mx-auto ">
              {/* Dev 1 */}
              <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group bg-purple-50 hover:bg-purple-600 rounded-xl shadow-lg">
                <img
                ...
                <p className="mt-2 text-slate-500 capitalize group-hover:text-slate-700">
                  Backend Developer
                </p>
                {/* contact Dev 1 */}
                <div className="flex mt-3 -mx-2">
                  <Link
                    href={"https://www.facebook.com/hannarong.tonkra"}
                    target="blank"
                    className="mx-2 text-slate-500 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Facebook"
                  >
                    <svg
                  ...
                  <Link
                    href={"https://www.instagram.com/tkishkk/"}
                    target="blank"
                    className="mx-2 text-slate-500 hover:text-gray-500 group-hover:text-white btnZoom"
                  ...
                  <Link
                    href={"https://github.com/Shiberger"}
                    target="blank"
                    className="mx-2 text-slate-500 dark:text-gray-300 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Github"
                  >
                    <svg
                      className="w-6 h-6 fill-current"
              ...
              <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group bg-purple-50 hover:bg-purple-600 rounded-xl shadow-md">
                ...
                <div className="flex mt-3 -mx-2">
                  <Link
                    href={"https://www.facebook.com/kornchanok.subsin/"}
                    target="blank"
                    className="mx-2 text-slate-500 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Facebook"
                  >
                  ...
                  <Link
                    href={"https://www.instagram.com/bamkn_/"}
                    target="blank"
                    className="mx-2 text-slate-500 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Instagram"
                  >
                  ...
                  <Link
                    href={"https://github.com/BamKS110"}
                    target="blank"
                    className="mx-2 text-slate-500 dark:text-gray-300 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Github"
                  >
