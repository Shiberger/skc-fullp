        ...
        <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <Link href={"mailto:prcosciswu@gmail.com"} className="text-blue-500 leading-relaxed hover:text-blue-300">
                prcosciswu@gmail.com
                </Link>
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p className="leading-relaxed">02-649-5000 <br /> EXT 11275 , 02-259-2343</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 md:w-1/2 bg-transparent flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <p className="leading-relaxed mb-5 text-gray-600">
              ร่วมพูดคุยแสดงความความคิดเห็น ให้คำแนะนำติชมได้ที่นี่!
            </p>
