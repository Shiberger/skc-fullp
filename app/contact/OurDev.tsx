              ...
              <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group bg-purple-50 hover:bg-purple-600 rounded-xl shadow-md">
                ...
                <div className="flex mt-3 -mx-2">
                  <Link
                    ...
                    target="blank"
                    className="mx-2 text-gray-600 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Facebook"
                  >
                    <svg
                  ...
                  <Link
                    ...
                    target="blank"
                    className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 group-hover:text-white btnZoom"
                    aria-label="Github"
                  >
                    <svg
                      className="w-6 h-6 fill-current"
