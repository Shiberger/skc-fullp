...
function Tools() {
  return (
    <div className="">
      <section
        id="features"
        className="container mx-auto px-4 space-y-6 py-8 dark:bg-transparent md:pt-40 md:mt-10 lg:py-20"
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center ">
          <h2 className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-3xl lg:text-6xl">
            Features
          </h2>
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-purple-200 p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current">
